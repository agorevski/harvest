    ...
    <FarmContainer>
      ...
      <FarmStatsContainer>
          ...
          <ReactTooltip
            ...
            getContent={() => (
              <TextContainer textAlign="left" margin="0px">
                <b>90%</b> of profits goes to farmers depositing in <b>asset pools</b>
                <br /> <b>10%</b> goes to those farmers staking <b>FARM</b>
              </TextContainer>
            )}
          />
          <StatsBoxTitle>
        ...
        <ReactTooltip
          ...
          getContent={() => (
            <StatsTooltip>
              <b>FARM</b> stakers receive <b>10%</b> of profits generated by all other pools
              <br />
              {profitShareAPYFallback ? (
                <>
