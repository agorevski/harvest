  ...
  return (
    <>
      {!ExperimentalSoftwareAcknowledgedField ? (
        ...
        >
          <p>
            Due to regulatory uncertainty, <b>TrueYield</b> is not available to people or
          ...
          <p>
            By interacting with the TrueYield website and/or smart contracts, the user
            acknowledges the experimental nature of yield farming with TrueYield, its
            dependency on 3rd party protocols, and{' '}
            <b>the potential for total loss of funds deposited.</b> The user accepts full liability
            for their usage of TrueYield, and no financial responsibility is placed on the
