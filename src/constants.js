...
export const FAQ_ITEMS = [
  {
    question: 'What is TrueYield?',
    answer: (
      <>
        TrueYield is an international cooperative of humble farmers pooling resources together in
        order to earn DeFi yields.
        <br />
        <br />
        When farmers deposit, TrueYield automatically farms the <b>highest yields</b> with these
        deposits using the <b>latest farming techniques.</b>
      </>
    ),
  },
  {
    question: 'Why TrueYield?',
    answer: (
      <>
        <ul>
  ...
  {
    question: 'How to use TrueYield?',
    answer: (
      <>
        The following community-made video explains how to deposit USDC for farming on TrueYield.
        <br />
        <br />
        <iframe
          title="tutorial"
      ...
      <>
        ...
        <ul>
          <li>
            ...
            is a cashflow token for TrueYield. It is available on{' '}
            <a
          ...
          <li>
            ...
            is a yield-bearing token for TrueYield. It can be acquired by depositing into FARM on the
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        versions of the corresponding assets which are being automatically farmed by TrueYield. When
        TrueYield generates yields, 90% of these yields are used to increase the value of these
        tokens.
        <br />
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        is a cashflow token for TrueYield. When TrueYield generates yields, 90% of these yields are used
        to increase the value of the deposits. The other 10% are converted into <b>FARM</b> tokens
        which are used for:
        <br />
        <br />
        <ul>
  ...
  },
  {
    ...
    answer: (
      <ul>
        ...
        <li>TrueYield was completely bootstrapped, with no VCs and no premine.</li>
      </ul>
    ),
  },
  {
    question: 'Is TrueYield audited?',
    answer: (
      <>
        <ul>
          <li style={{ marginBottom: '20px' }}>
            The TrueYield smart contracts have been designed from the ground up with security in mind,
            by using as many audited components as possible. Please review the smart contracts
            before depositing funds.
          </li>
          <li style={{ marginBottom: '20px' }}>
            The TrueYield smart contracts are{' '}
  ...
  {
    question: 'What is the road map for TrueYield?',
  ...
  {
    question: 'Where can I learn more about TrueYield?',
    answer: (
      <span>
        <span role="img" aria-label="emoji">
          👩‍🌾
        </span>{' '}
        The TrueYield Community Documentation has a wealth of up-to-date information <br />
  ...
  {
    question: 'TrueYield is proud to be listed on:',
    answer: (
      <div
        style={{
          marginLeft: 'auto',
